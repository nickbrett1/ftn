...
describe('Card Detail Page', () => {
	...
	it('renders card info and buttons', () => {
		...
		expect(document.querySelector('[data-testid="edit-card-name-input"]').value).toBe('Chase Freedom');
	...
	it('shows validation error if fields are empty', async () => {
		...
		expect(document.querySelector('[data-testid="save-error"]').textContent).toContain('Please enter both card name and last 4 digits');
	...
	it('shows validation error if last4 is not 4 digits', async () => {
		...
		expect(document.querySelector('[data-testid="save-error"]').textContent).toContain('Last 4 digits must be exactly 4 numbers');
	...
	it('shows error if save fails', async () => {
		...
		expect(document.querySelector('[data-testid="save-error"]').textContent).toContain('Save failed');
	...
	it('shows error if delete fails', async () => {
		...
		expect(document.querySelector('[data-testid="delete-error"]').textContent).toContain('Delete failed');
