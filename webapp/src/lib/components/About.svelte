...
<div class="relative left-0 w-full overflow-hidden py-24 backdrop-blur">
	<div class="relative mx-auto max-w-7xl px-4 md:px-6">
		<a id="about"
			><div class="relative mx-auto mb-20 text-xl leading-none text-green-400">&rarr; HELLO</div></a
		>
		<p
		...
		<div class="gap-24 text-pretty md:columns-2">
			<p class="text-sm leading-normal text-white sm:text-base">
				Over nearly 20 years, I've worked in most of the key functions for fintech data, from
				managing global data partner relationships at Bloomberg LP, to building the data systems to
				deliver massive scale analytics at Meta. I've managed large global organizations, with teams
				from Tokyo to New York, Dubai to Sydney. But also taken high impact individual contributor
				roles to be the hands-on leader for new initiatives. For most of my career I've worked in
				Engineering roles, but for 3-years ran a Product Management team, and have a passion for
				marrying the skills to <strong class="font-extrabold text-white"
