		...
		<ul class="flex border-t border-white/20 pt-8 text-sm text-white sm:gap-32">
			...
			<li class="flex">
				<a
					...
					class="hover:text-green-400 -mt-1 block size-[48px] p-1"
				>
					<EnvelopeRegular /></a
				>
				<a href="https://github.com/nickbrett1/" class=" -mt-1 block size-[48px] p-1">
					<GithubBrands />
				</a>

				<a
					href="https://www.linkedin.com/in/nick-brett/"
					class="hover:text-sky-600 -mt-1 block size-[48px] p-1"
				>
					<LinkedinInBrands />
				</a>
			</li>
