...
vi.mock('$lib/images/original-architecture-sketch.jpeg?as=run', () => ({ default: 'mocked-image-src' }));

describe('Data Arch Diagram Page', () => {
  it('does not display the goal explanation text', () => {
    render(Page);

    const explanation = screen.queryByText('My goal was to build on the concepts and explain them to others.');
