...
test.describe('Preview API Contract', () => {
	test('POST /api/projects/genproj/api/preview should return a project preview', async ({
		request
	}) => {
	...
	test('POST /api/projects/genproj/api/preview should reject invalid configuration', async ({
		request
	}) => {
		const response = await request.post('/api/projects/genproj/api/preview', {
			data: {
