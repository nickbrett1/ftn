...
import { generatePreview, organizeFilesIntoFolders } from '../../../src/lib/server/preview-generator.js';
...
describe('generatePreview', () => {
    ...
    it('handles errors during preview generation', async () => {
        ...
        await expect(generatePreview({}, [])).rejects.toThrow('Failed to generate preview: Resolution failed');
    });
});
